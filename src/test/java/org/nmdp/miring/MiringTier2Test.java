...
public class MiringTier2Test
{
    ...
    public void testMiringElement1Tier2()
    {
        ...
        String oidHmlidErrorReport = new MiringValidator(xml,"1.0.1").validate();
        
        xml = Utilities.readXmlResource("/org/nmdp/miring/hml/Element1.hmlid.not.OID.xml");
        String notOidHmlidErrorReport = new MiringValidator(xml,"1.0.1").validate();
        ...
        String validTestIDErrorReport = new MiringValidator(xml,"1.0.1").validate();
        
        xml = Utilities.readXmlResource("/org/nmdp/miring/hml/Element1.invalid.testidsource.xml");
        String invalidTestIDErrorReport = new MiringValidator(xml,"1.0.1").validate();
    ...
    public void testMiringElement2Tier2()
    {
        ...
        String results = new MiringValidator(xml,"1.0.1").validate();
        ...
        String badResults = new MiringValidator(xml,"1.0.1").validate();

        xml = Utilities.readXmlResource("/org/nmdp/miring/hml/Element2.refsequence.match.csb.xml");
        String goodResults = new MiringValidator(xml,"1.0.1").validate();
