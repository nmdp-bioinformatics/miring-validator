...
public class MiringTier1Test
{
    ...
    public void testMiringElement2Tier1()
    {
        ...
        String results = new MiringValidator(xml).validate();
        System.out.println("Results of Miring Tier 1 element 2= "+ results);
    ...
    public void testMiringElement3Tier1()
    {
        ...
        String results = new MiringValidator(xml).validate();
        System.out.println("Results of Miring Tier 1 element 3= "+ results);
    ...
    public void testMiringElement4Tier1()
    {
        ...
        System.out.println("Results of Miring Tier 1 element 4= "+ badResults);
