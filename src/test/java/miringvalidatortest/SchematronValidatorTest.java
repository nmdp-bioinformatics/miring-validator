...
{
    Logger logger = LoggerFactory.getLogger(SchematronValidatorTest.class);
    ...
    public void schematronValidatorTest()
    {
        ...
        String errorReport = ReportGenerator.generateReport(badDemoErrors, Utilities.getHMLIDRoot(demoGoodXML), Utilities.getHMLIDExtension(demoGoodXML), null, null);
